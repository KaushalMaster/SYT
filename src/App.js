...
function App() {
  ...
  const [tineriesId, setItineriesId] = useState("");
                ...
                <hotelName.Provider value={{ hotel, setHotel }}>
                  <Itineries.Provider value={{ tineriesId, setItineriesId }}>
                    <Routes>
                      ...
                      <Route path="/my-boocking" element={<Boocking />} />
                      <Route
                      ...
                      <Route path="/vendor/home-page" element={<Home_page />} />
                      <Route
                      ...
                      />
                      <Route
                        path="/vendor/add-itineriesEdit/:id"
                        element={<AddItineriesEdit />}
                      />
                      <Route path="/vendor/add-hotel" element={<AddHotel />} />
                    </Routes>
                  </Itineries.Provider>
                </hotelName.Provider>
              </ids.Provider>
