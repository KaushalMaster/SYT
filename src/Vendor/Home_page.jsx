...
import { faArrowLeft, faSearch, faBell, faBrush, faCheck, faCheckCircle, faClipboard, faEnvelopeOpen,  faLayerGroup, faLocationPin, faStar, faUser, faXmark, faXmarkCircle } from '@fortawesome/free-solid-svg-icons';
                                        ...
                                        <div className='ps-md-4 ps-sm-2 ps-2 pe-xl-5 pe-lg-5 pe-md-3 pe-sm-2 pe-2 align-items-center d-flex justify-content-between'>
                                            <div className='w-50 d-flex align-items-center'>
                                                <div className='w-75 input_search_box'>
                                                  <input type="text" name="" id="" placeholder='Search' className='second_navbar_input'/>
