          ...
          <section className="py-5" style={{ backgroundColor: "whitesmoke" }}>
            <div className="row gx-5 gy-4 me-xl-5 me-lg-5 me-md-0 me-sm-0 me-0 ps-3">
              ...
              {/* <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                <div
                  className="row only_for_green_border p-xl-3 p-lg-3 p-md-3 p-sm-3 p-2 costum_requirments"
                  onClick={() => navigate("/display/custom/details")}
                  style={{ backgroundColor: "#ffffff" }}
                >
                  <div className="col-1 px-xl-2 px-lg-0 px-md-0 px-sm-0 costum_requirments_span">
                    <span className="cmnp cmnbkg">1</span>
                  </div>
                  <div className="col-xl-7 col-lg-11 col-md-11 col-sm-11 col-6 costum_requirments_center">
                    <div className="d-flex align-item-center pt-2 py-1">
                      <FontAwesomeIcon icon={faUser} className="cmnclr" />
                      <p className="cmnp ps-1"> James Bond</p>
                    </div>
                    <div className="d-flex align-item-center pt-2 py-1">
                      <FontAwesomeIcon
                        icon={faLocationPin}
                        className="cmnclr"
                      />
                      <p className="cmnp ps-1"> Destination : Mumbai</p>
                    </div>
                    <div className="d-flex align-item-center pt-2 py-1">
                      <FontAwesomeIcon icon={faCalendar} className="cmnclr" />
                      <p className="cmnp ps-1">11 Apr to 22 Apr</p>
                    </div>
                    <div className="py-1">
                      <span className="cmnp" style={{ color: "#B8B8B8" }}>
                        Package ID : 1234567
                      </span>
                    </div>
                  </div>
