...
function Registation_vandor(props) {
  ...
  const RegistrationNext = async (e) => {
    e.preventDefault();
    const { full_name, mobile_number, email_address, alternate_phone, resident_address, alternate_address, pincode, skypeid, country, city, state } = vendorRegistration;

    if (full_name.length <= 0 || mobile_number.length < 10 || alternate_phone.length < 10 || pincode.length < 6 || resident_address.length <= 0 || alternate_address.length <= 0 || skypeid.length <= 0 || !/^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}$/i.test(email_address)) {
              ...
              <form>
                <Row className="gy-2 gx-5">
                  <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 py-1">
                    ...
                    <input type="text" name="full_name" onChange={vRegistration} id="" className="w-100" />
                  ...
                  <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 py-1">
                    ...
                    <input type="tel" name="mobile_number" onChange={vRegistration} id="" maxLength={10} />
                  ...
                  <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 py-1">
                    ...
                    <input type="email" name="email_address" onChange={vRegistration} id="" />
                    {vendorRegistration.email_address.length < 0 || !/^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}$/i.test(vendorRegistration.email_address) ? (
                      <span style={{ color: "red", fontSize: "12px" }}>
                        {email}
                      </span>
                    ) : (
                  ...
                  <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 py-1">
                    ...
                    <input type="tel" name="alternate_phone" onChange={vRegistration} id="" maxLength={10} />
                  ...
                  <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 py-1">
                    <p className="cmnp mb-2 fw-normal text-20">Residential Area*</p>
                    <input type="text" name="resident_address" onChange={vRegistration} id="" />
                  ...
                  <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 py-1">
                    ...
                    <input type="text" name="alternate_address" onChange={vRegistration} id="" />
                  ...
                  <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 py-1">
                    ...
                    <input type="tel" name="pincode" onChange={vRegistration} maxLength={6} />
                  ...
                  <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 py-1">
                    ...
                    <input type="email" name="skypeid" onChange={vRegistration} id="" />
                ...
                <div className="text-center sing_up_button">
                  <Button type="submit" className="w-50" onClick={RegistrationNext}>
                    Next
                  </Button>
                </div>
              </form>
