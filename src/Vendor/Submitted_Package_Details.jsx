...
function Submitted_Package_Details(props) {
    ...
    const Details = async () => {
        const res = await fetch("https://start-your-tour.onrender.com/package/getPackageData?package_id=6238313cedbea3cf73b42137", {
            method: "GET",
            headers: {
        ...
        <>
            ...
            <div className="costum_container">
                ...
                <div style={{ backgroundColor: "whitesmoke" }}>
                    ...
                    <section className='submited_package_details mt-3' style={{ backgroundColor: "#fff" }}>
                        ...
                        <div className='name_city_padding submited_package_details_border'>
                            <div className="row">
                                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <p className='cmnp text-20 mb-2 submited_package_details_font'>Name</p>
                                    <Form.Control type="Email" id='name' name='name' placeholder='Gautam Shah' className='submited_package_details_border submited_package_details_placeholder' />
                                </div>
                                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <p className='cmnp text-20 mb-2 submited_package_details_font'>City</p>
                                    <Form.Control type="Email" id='name' name='name' placeholder='Ahmedabad-Goa' className='submited_package_details_border submited_package_details_placeholder' />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='submited_package_details_border name_city_padding my-4'>
                            <div className="row gy-3">
                                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <p className='cmnp text-20 submited_package_details_font'>Package category</p>
                                    <Form.Control type="Email" id='name' name='name' className='submited_package_details_border submited_package_details_placeholder' placeholder='Honeymoon' />
                                </div>
                                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <p className='cmnp text-20 submited_package_details_font'>Package</p>
                                    <Form.Control type="Email" id='name' name='name' className='submited_package_details_border submited_package_details_placeholder' placeholder='Ahmedabad-Goa' />
                                </div>
                                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <p className='cmnp text-20 submited_package_details_font'>Number Of People</p>
                                    <Form.Control type="Email" id='name' name='name' className='submited_package_details_border submited_package_details_placeholder' placeholder='2' />
                                </div>
                                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <p className='cmnp text-20 submited_package_details_font'>Travel By</p>
                                    <Form.Control type="Email" value={submitedDetails.travel_by} id='name' name='name' className='submited_package_details_border submited_package_details_placeholder' />
                                </div>
                                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <p className='cmnp text-20 submited_package_details_font'>Total Days</p>
                                    <Form.Control type="Email" id='name' value={submitedDetails.total_days} name='name' className='submited_package_details_border submited_package_details_placeholder' placeholder='3 Days & 2 Night' />
                                </div>
                                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <p className='cmnp text-20 submited_package_details_font'>Total Nights</p>
                                    <Form.Control type="Email" id='name' value={submitedDetails.total_nights} name='name' className='submited_package_details_border submited_package_details_placeholder' placeholder='3 Days & 2 Night' />
                                </div>
                                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <p className='cmnp text-20 submited_package_details_font'>Personal Care</p>
                                    <Form.Control type="Email" id='name' name='name' className='submited_package_details_border submited_package_details_placeholder' placeholder='Yes' />
                                </div>
                                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <p className='cmnp text-20 submited_package_details_font'>Hotel Type</p>
                                    <Form.Control type="Email" id='name' value={submitedDetails.hotel_type} name='name' className='submited_package_details_border submited_package_details_placeholder' placeholder='3 Stars' />
                                </div>
                                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <p className='cmnp text-20 submited_package_details_font'>Meal Include</p>
                                    <Form.Control type="Email" id='name' value={submitedDetails.meal_required} name='name' className='submited_package_details_border submited_package_details_placeholder' placeholder='Yes | VEG' />
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div className='cmn p-3 my-2'>
                                <h6 className='py-1 costom_36_font mx-xl-3 mx-lg-3 mx-md-2 mx-sm-1 mx-1'>Hotels</h6>
                                            ...
                                            <div className='col-lg-9'>
                                                <div className='px-3'>
                                                    <div className='p-2 cmn d-flex text-justify mt-2'>
                                                        <div>
                                                            <h6 className='cmnp p-3 costom_24_font text-dark'>Day 1</h6>
                                                        </div>
                                                        <div className='ps-3' style={{ borderLeft: '1px solid #B8B8B8' }}>
                                                            <p className='cmnp costom_24_font'>Montego Bay Beach Village</p>
                                        ...
                                        <Row className='align-items-center'>
                                            ...
                                            <div className='col-lg-9'>
                                                <div className='px-3'>
                                                    <div className='p-2 cmn d-flex text-justify mt-2'>
                                                        <div>
                                                            <h6 className='cmnp p-3 costom_24_font text-dark'>Day 2</h6>
                                                        </div>
                                                        <div className='ps-3' style={{ borderLeft: '1px solid #B8B8B8' }}>
                                                            <p className='cmnp costom_24_font'>Sea Queen Beach Resort and SPA</p>
                                                            <p className='cmnp'><FontAwesomeIcon icon={faLocationPin} /> Goa</p>
                                                        </div>
                                                    </div>
                                                    <div className='py-2'>
                                        ...
                                        <Row className='align-items-center'>
                                            ...
                                            <div className='col-lg-9'>
                                                <div className='px-3'>
                                                    <div className='p-2 cmn d-flex text-justify mt-2'>
                                                        <div>
                                                            <h6 className='cmnp p-3 costom_24_font text-dark'>Day 3</h6>
                                                        </div>
                                                        <div className='ps-3' style={{ borderLeft: '1px solid #B8B8B8' }}>
                                                            <p className='cmnp costom_24_font'>De Lagom Comforts Goa</p>
                                                            <p className='cmnp'><FontAwesomeIcon icon={faLocationPin} /> Goa</p>
                                                        </div>
                                                    </div>
                                                    <div className='py-2'>
